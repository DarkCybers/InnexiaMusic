...
from plugins.play import generate_cover
from plugins.play import arq
from plugins.play import cb_admin_check
from plugins.play import transcode
from plugins.play import convert_seconds
from plugins.play import time_to_seconds
from plugins.play import changeImageSize
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @InnexiaVCBot to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
